...
########################文字检测########################
models=r"C:\Users\Administrator\Desktop\msdszhong\invoice-master\invoice-master/models/"
##文字检测引擎 
pwd = os.getcwd()
opencvFlag = 'keras' ##keras,opencv,darknet，模型性能 keras>darknet>opencv
IMGSIZE = (960, 768)## yolo3 输入图像尺寸
keras_anchors = '8,9, 8,18, 8,31, 8,59, 8,124, 8,351, 8,509, 8,605, 8,800'
class_names = ['none','text',]
kerasTextMModel_invoice = os.path.join(pwd,models,"haiguan100.h5")##keras海关税票权重文件trained_weights.h5
############## darknet yolo  ##############
...
if chinsesModel:
    if LSTMFLAG:
        ocrModel  = os.path.join(pwd,models,"model_acc97.pth")#model_acc97.pth
    else:
